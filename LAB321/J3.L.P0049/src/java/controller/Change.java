...
import dataControl.CalendarManager;
...
public class Change extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            ArrayList<CalendarDate> list = CalendarManager.getCalendar(yyyy, mm);
            String month = new SimpleDateFormat("MMM === yyyy", Locale.ENGLISH).format(c.getTime());
            request.setAttribute("cm", mm);
            request.setAttribute("cy", yyyy);
