...
public class SessionFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        UserInfor user = (UserInfor) ses.getAttribute("user");
        if (user == null) {
        } else if (user.getType().equalsIgnoreCase("student") && (url.contains("MakeQuiz") || url.contains("ManageQuiz"))) {
            res.sendRedirect("Home");
        } else if (user.getType().equalsIgnoreCase("teacher")
                && (url.contains("Next") || url.contains("StartQuiz") || url.contains("TakeQuiz") || url.contains("Finish"))) {
            res.sendRedirect("Home");
        }
